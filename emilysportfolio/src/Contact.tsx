function Contact() {
    return(
        ...
        <section id="contact" className="flex flex-col md:items-start md:mx-28 justify-center min-h-screen">
            ...
            <div className="flex flex-col gap-1 left-1/2 text-start items-center md:items-start md:translate-x-0 mt-6 md:mt-12 ">
                ...
                <p className="text-start text-secondary"><img src="/./img/linkedin.png" alt="LinkedIn" className="w-6 inline-block mr-3" /><a className="cursor-pointer" href="https://www.linkedin.com/in/emilyfgouw" target="_blank">linkedin.com/in/emilyfgouw</a></p>
            </div>
        </section>
        </>
    )
